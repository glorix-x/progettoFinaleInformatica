namespace ProgettoFinaleInformatica {
    partial class FormSettimana {
        ...
        private void InitializeComponent() {
            ...
            lblMercoledi = new Label();
            lblGiovedi = new Label();
            ...
            // grigliaSettimana
            // 
            grigliaSettimana.CellBorderStyle = TableLayoutPanelCellBorderStyle.Single;
            grigliaSettimana.ColumnCount = 7;
            grigliaSettimana.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.28571F));
            grigliaSettimana.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.2857161F));
            grigliaSettimana.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.2857161F));
            grigliaSettimana.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.2857161F));
            grigliaSettimana.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.2857161F));
            grigliaSettimana.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 14.2857161F));
            ...
            grigliaSettimana.RowStyles.Add(new RowStyle(SizeType.Percent, 4.16986132F));
            grigliaSettimana.RowStyles.Add(new RowStyle(SizeType.Percent, 4.1665287F));
            grigliaSettimana.RowStyles.Add(new RowStyle(SizeType.Percent, 4.1665287F));
            grigliaSettimana.RowStyles.Add(new RowStyle(SizeType.Percent, 4.1665287F));
            grigliaSettimana.RowStyles.Add(new RowStyle(SizeType.Percent, 4.1665287F));
            grigliaSettimana.RowStyles.Add(new RowStyle(SizeType.Percent, 4.1665287F));
            ...
            grigliaSettimana.RowStyles.Add(new RowStyle(SizeType.Percent, 4.1665287F));
            grigliaSettimana.RowStyles.Add(new RowStyle(SizeType.Percent, 4.1665287F));
            grigliaSettimana.Size = new Size(1310, 773);
            ...
            Controls.Add(lblGiovedi);
            Controls.Add(lblMercoledi);
        ...
        private TableLayoutPanel grigliaSettimana;
        private Label lblLunedi;
        private Label lblMartedi;
        private Label lblMercoledi;
        private Label lblGiovedi;
